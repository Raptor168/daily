...
const swiper1 = new (_vendor_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_0___default())('.slider-hero', {
  // Optional parameters
...
const swiper2 = new (_vendor_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_0___default())('.slider-cards', {
  // Optional parameters
  // slidesPerView: 1,
  direction: 'horizontal',
  loop: false,
  ...
  breakpoints: {
    0: {
      slidesPerView: 1.3,
      centeredSlides: true // slidesOffsetBefore: '25%',
...
!function (e, t) {
      ...
      updateSlides: function () {
        ...
        for (let i = 0; i < c; i += 1) {
          ...
          if (C && e.grid.updateSlide(i, n, c, t), "none" !== n.css("display")) {
            ...
            } else $ = (r - (a.slidesPerView - 1) * x) / a.slidesPerView, a.roundLengths && ($ = Math.floor($)), p[i] && (p[i].style[t("width")] = "".concat($, "px"));
        ...
        if (e.virtualSize = Math.max(e.virtualSize, r) + v, n && l && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
          ...
          [t("width")]: "".concat(e.virtualSize + a.spaceBetween, "px")
    ...
    slide: {
      ...
      slideToClickedSlide: function () {
        ...
        if (t.loop) {
          ...
          i = parseInt(d(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - a / 2 || r > e.slides.length - e.loopedSlides + a / 2 ? (e.loopFix(), r = s.children(".".concat(t.slideClass, "[data-swiper-slide-index=\"").concat(i, "\"]:not(.").concat(t.slideDuplicateClass, ")")).eq(0).index(), c(() => {
            e.slideTo(r);
          })) : e.slideTo(r) : r > e.slides.length - a ? (e.loopFix(), r = s.children(".".concat(t.slideClass, "[data-swiper-slide-index=\"").concat(i, "\"]:not(.").concat(t.slideDuplicateClass, ")")).eq(0).index(), c(() => {
            e.slideTo(r);
          })) : e.slideTo(r);
        } else e.slideTo(r);
      }
  ...
  const J = [function (_ref7) {
    ...
    function i(t, s) {
      ...
      const i = a.renderSlide ? d(a.renderSlide.call(e, t, s)) : d("<div class=\"".concat(e.params.slideClass, "\" data-swiper-slide-index=\"").concat(s, "\">").concat(t, "</div>"));
    ...
    function r(t) {
      ...
      const y = [],
            E = [];
      if (t) e.$wrapperEl.find(".".concat(e.params.slideClass)).remove();else for (let t = o; t <= d; t += 1) (t < v || t > w) && e.$wrapperEl.find(".".concat(e.params.slideClass, "[data-swiper-slide-index=\"").concat(t, "\"]")).remove();
    ...
    function p() {
      ...
      if (e.params.loop ? (c = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), c > i - 1 - 2 * e.loopedSlides && (c -= i - 2 * e.loopedSlides), c > u - 1 && (c -= u), c < 0 && "bullets" !== e.params.paginationType && (c = u + c)) : c = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
        ...
        let i, l, u;
        if (s.dynamicBullets && (r = a.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), p.css(e.isHorizontal() ? "width" : "height", r * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (n += c - (e.previousIndex - e.loopedSlides || 0), n > s.dynamicMainBullets - 1 ? n = s.dynamicMainBullets - 1 : n < 0 && (n = 0)), i = Math.max(c - n, 0), l = i + (Math.min(a.length, s.dynamicMainBullets) - 1), u = (l + i) / 2), a.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => "".concat(s.bulletActiveClass).concat(e)).join(" ")), p.length > 1) a.each(e => {
          const t = d(e),
                a = t.index();
          a === c && t.addClass(s.bulletActiveClass), s.dynamicBullets && (a >= i && a <= l && t.addClass("".concat(s.bulletActiveClass, "-main")), a === i && o(t, "prev"), a === l && o(t, "next"));
        });else {
          const t = a.eq(c),
                r = t.index();
          ...
          if (t.addClass(s.bulletActiveClass), s.dynamicBullets) {
            ...
            for (let e = i; e <= l; e += 1) a.eq(e).addClass("".concat(s.bulletActiveClass, "-main"));
        ...
        if (s.dynamicBullets) {
          const i = Math.min(a.length, s.dynamicMainBullets + 4),
                n = (r * i - r) / 2 - u * r,
                l = t ? "right" : "left";
          a.css(e.isHorizontal() ? l : "top", "".concat(n, "px"));
        }
      }
      ...
      if ("fraction" === s.type && (p.find(W(s.currentClass)).text(s.formatFractionCurrent(c + 1)), p.find(W(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
        ...
        let i = 1,
            r = 1;
        "horizontal" === t ? i = a : r = a, p.find(W(s.progressbarFillClass)).transform("translate3d(0,0,0) scaleX(".concat(i, ") scaleY(").concat(r, ")")).transition(e.params.speed);
      }
    ...
    function c() {
      ...
      if ("bullets" === t.type) {
        ...
        for (let s = 0; s < a; s += 1) t.renderBullet ? r += t.renderBullet.call(e, s, t.bulletClass) : r += "<".concat(t.bulletElement, " class=\"").concat(t.bulletClass, "\"></").concat(t.bulletElement, ">");
    ...
    function f() {
      ...
      let d = l,
          p = (o - l) * a;
      s ? (p = -p, p > 0 ? (d = l - p, p = 0) : -p + l > o && (d = o + p)) : p < 0 ? (d = l + p, p = 0) : p + l > o && (d = o - p), e.isHorizontal() ? (i.transform("translate3d(".concat(p, "px, 0, 0)")), i[0].style.width = "".concat(d, "px")) : (i.transform("translate3d(0px, ".concat(p, "px, 0)")), i[0].style.height = "".concat(d, "px")), n.hide && (clearTimeout(h), r[0].style.opacity = 1, h = setTimeout(() => {
    ...
    function T() {
      ...
      let r = i.find(".".concat(e.params.scrollbar.dragClass));
    ...
    function l(t) {
      ...
      const r = e.virtual && e.params.virtual.enabled ? e.$wrapperEl.children(".".concat(e.params.slideClass, "[data-swiper-slide-index=\"").concat(t, "\"]")) : e.slides.eq(t),
      ...
      !r.hasClass(i.elementClass) || r.hasClass(i.loadedClass) || r.hasClass(i.loadingClass) || n.push(r[0]), 0 !== n.length && n.each(t => {
        ...
        e.loadImage(n[0], p || o, c, u, !1, () => {
          if (null != e && e && (!e || e.params) && !e.destroyed) {
            if (o ? (n.css("background-image", "url(\"".concat(o, "\")")), n.removeAttr("data-background")) : (c && (n.attr("srcset", c), n.removeAttr("data-srcset")), u && (n.attr("sizes", u), n.removeAttr("data-sizes")), h.length && h.children("source").each(e => {
              const t = d(e);
              ...
              if (r.hasClass(e.params.slideDuplicateClass)) {
                l(e.$wrapperEl.children("[data-swiper-slide-index=\"".concat(t, "\"]:not(.").concat(e.params.slideDuplicateClass, ")")).index(), !1);
              } else {
                l(e.$wrapperEl.children(".".concat(e.params.slideDuplicateClass, "[data-swiper-slide-index=\"").concat(t, "\"]")).index(), !1);
              }
            }
    ...
    function o() {
      ...
      if ("auto" === p && (p = 0), n || (n = !0), e.params.watchSlidesProgress) t.children(".".concat(s.slideVisibleClass)).each(e => {
      ...
      if (o.loadPrevNext) if (p > 1 || o.loadPrevNextAmount && o.loadPrevNextAmount > 1) {
        ...
        const e = t.children(".".concat(s.slideNextClass));
        e.length > 0 && l(u(e));
        const a = t.children(".".concat(s.slidePrevClass));
        a.length > 0 && l(u(a));
      }
    }
    ...
    const n = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
      ...
      if (e.params.history.root.length > 0) {
        ...
        "/" === s[s.length - 1] && (s = s.slice(0, s.length - 1)), d = "".concat(s, "/").concat(t, "/").concat(d);
    ...
    const p = () => {
      ...
      if (t !== e.slides.eq(e.activeIndex).attr("data-hash")) {
        const s = e.$wrapperEl.children(".".concat(e.params.slideClass, "[data-hash=\"").concat(t, "\"]")).index();
        if (void 0 === s) return;
        e.slideTo(s);
      }
    },
    ...
    function r() {
      ...
      if (i = t.params.loop ? parseInt(d(t.clickedSlide).attr("data-swiper-slide-index"), 10) : s, e.params.loop) {
        ...
        const s = e.slides.eq(t).prevAll("[data-swiper-slide-index=\"".concat(i, "\"]")).eq(0).index(),
              a = e.slides.eq(t).nextAll("[data-swiper-slide-index=\"".concat(i, "\"]")).eq(0).index();
    ...
    function l(t) {
      ...
      if (e.realIndex !== s.realIndex || r) {
        ...
        if (s.params.loop) {
          ...
          const t = s.slides.eq(o).prevAll("[data-swiper-slide-index=\"".concat(e.realIndex, "\"]")).eq(0).index(),
                a = s.slides.eq(o).nextAll("[data-swiper-slide-index=\"".concat(e.realIndex, "\"]")).eq(0).index();
    ...
    t({
      ...
      updateWrapperSize: (t, a, i) => {
        ...
        if (e.virtualSize = (t + r) * s, e.virtualSize = Math.ceil(e.virtualSize / o) - r, e.$wrapperEl.css({
          [i("width")]: "".concat(e.virtualSize + r, "px")
        }), n) {
          a.splice(0, a.length);
          const t = [];
    ...
    t({
      ...
      setTranslate: () => {
        ...
        for (let e = 0; e < a.length; e += 1) {
          ...
          const v = "rotateX(".concat(c ? 0 : -i, "deg) rotateY(").concat(c ? i : 0, "deg) translate3d(").concat(h, "px, ").concat(f, "px, ").concat(g, "px)");

          if (o <= 1 && o > -1 && (m = 90 * s + 90 * o, n && (m = 90 * -s - 90 * o)), t.transform(v), p.slideShadows) {
            let e = c ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                s = c ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
            0 === e.length && (e = d("<div class=\"swiper-slide-shadow-".concat(c ? "left" : "top", "\"></div>")), t.append(e)), 0 === s.length && (s = d("<div class=\"swiper-slide-shadow-".concat(c ? "right" : "bottom", "\"></div>")), t.append(s)), e.length && (e[0].style.opacity = Math.max(-o, 0)), s.length && (s[0].style.opacity = Math.max(o, 0));
          }
        }
        ...
        if (s.css({
          ...
          const e = Math.abs(m) - 90 * Math.floor(Math.abs(m) / 90),
                ...
                a = p.shadowScale / t,
                i = p.shadowOffset;
          h.transform("scale3d(".concat(s, ", 1, ").concat(a, ") translate3d(0px, ").concat(r / 2 + i, "px, ").concat(-r / 2 / a, "px) rotateX(-90deg)"));
        }
    ...
    t({
      ...
      setTranslate: () => {
        ...
        for (let i = 0; i < t.length; i += 1) {
          ...
          const u = "translate3d(".concat(p, "px, ").concat(c, "px, 0px) rotateX(").concat(d, "deg) rotateY(").concat(o, "deg)");
          U(a, r).transform(u);
        }
      },
      setTransition: t => {
    ...
    t({
      ...
      setTranslate: () => {
        ...
        for (let e = 0, t = a.length; e < t; e += 1) {
          ...
          const w = "translate3d(".concat(g, "px,").concat(f, "px,").concat(h, "px)  rotateX(").concat(u, "deg) rotateY(").concat(c, "deg) scale(").concat(v, ")");
    ...
    const a = e => "string" == typeof e ? e : "".concat(e, "px");
    ...
    F({
      ...
      setTranslate: () => {
        ...
        if (l) {
          ...
          s.transform("translateX(calc(50% - ".concat(t, "px))"));
        }
    ...
    t({
      ...
      setTranslate: () => {
        ...
        for (let l = 0; l < t.length; l += 1) {
          ...
          e.params.centeredSlides && !e.params.cssMode && e.$wrapperEl.transform("translateX(".concat(e.minTranslate(), "px)")), e.params.centeredSlides && e.params.cssMode && (c -= t[0].swiperSlideOffset);
          ...
          if (u = p < 0 ? "calc(".concat(u, "px + (").concat(v * Math.abs(p), "%))") : p > 0 ? "calc(".concat(u, "px + (-").concat(v * Math.abs(p), "%))") : "".concat(u, "px"), !e.isHorizontal()) {
            const e = h;
            h = u, u = e;
          }
